...
namespace TriaYazarKasaRestApi.Business.Libraries.Hugin.Internal
{
    public enum ErrorCode
    {
        ...
        [Description("Uygulama durumu uygun değil ECR durumu çağrılan işlevi desteklemiyor. Örneğin: Ödeme durumunda PrintItem işlevini çağıramazsınız veya ödeme başlarsa VoidReceipt işlevini çağıramazsınız.")]
        ERR_INVALID_STATE = 3,

        [Description("Geçersiz komut ECR modeli çağrılan işlevi desteklemiyor.")]
        ERR_INVALID_CMD = 4,
        ...
        [Description("Yazıcıda kağıt yok ECR, kağıt yoksa bu hatayı döndürür. Bu hatayı alırsanız, hata kodu 7'yi alana kadar yazıcı durumunu kontrol edin. Kağıtlar takıldıktan sonra (hata kodu 7), devam etmek için ClearError işlevini çağırmanız gerekir.")]
        ERR_NO_PAPER = 8,
        ...
        [Description("Departman satış tutarı limitini aşıldı.")]
